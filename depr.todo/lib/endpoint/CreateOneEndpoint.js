/**
 * @file Defines the CreateOneEndpoint class.
 *
 ...
 */
class CreateOneEndpoint extends BaseEndpoint {
	...
	constructor( cfg, overrides ) {
		...
		// Set Endpoint Type
		cfg.endpointType = "createOne";

		// Define the default response class
		cfg.defaultSuccessResponse 	= "CreateOneResponse";
...
module.exports = CreateOneEndpoint;

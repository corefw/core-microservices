/**
 * @file Defines the MissingRequestBodySchemaError class.
 */
 ...
 * to validate a request's body, but cannot be found.
 *
 * @memberOf Errors
 * @extends Errors.Abstract.MissingSchemaError
 */
class MissingRequestBodySchemaError extends MissingSchemaError {
...
module.exports = MissingRequestBodySchemaError;

/**
 * @file Defines the ServerlessInvokeExecutionContext class.
 *
 ...
 * AWS Lambda by way of `sls invoke` call.
 *
 * @memberOf ExecutionContext
 * @extends ExecutionContext.BaseLambdaExecutionContext
 */
class ServerlessInvokeExecutionContext extends BaseLambdaExecutionContext {

}

module.exports = ServerlessInvokeExecutionContext;

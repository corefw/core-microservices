...
class MetaDeploymentManager extends BaseGenerator {
	...
	get deployConfig() {
		...
		if( me._deployConfig === undefined || me._deployConfig === null ) {
			...
			me.$throw(
				"config.not.loaded",
				"Attempted to read the deployment configuration before it had been loaded; ensure that the ConfigManager has finished loading the the configuration before attempting to access the 'deployConfig' property."
			);

/**
 * @file Defines the GetOneEndpoint class.
 *
 ...
 */
class GetOneEndpoint extends BaseEndpoint {
	...
	constructor( cfg, overrides ) {
		...
		// Set Endpoint Type
		cfg.endpointType = "getOne";

		// Define the default response class
		cfg.defaultSuccessResponse 	= "GetOneResponse";

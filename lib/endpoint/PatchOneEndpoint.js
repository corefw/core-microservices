/**
 * @file Defines the PatchOneEndpoint class.
 *
 ...
 */
class PatchOneEndpoint extends BaseEndpoint {
	...
	constructor( cfg, overrides ) {
		...
		// Set Endpoint Type
		cfg.endpointType = "patchOne";

		// Define the default response class
		cfg.defaultSuccessResponse 	= "PatchOneResponse";
...
module.exports = PatchOneEndpoint;

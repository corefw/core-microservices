/**
 * @file Defines the InvalidContextKeyError class.
 */
...
/**
 * This error is thrown when an invalid context key is referenced.
 *
 * @memberOf Errors
 * @extends Errors.Abstract.ContextDataError
 */
class InvalidContextKeyError extends ContextDataError {
...
module.exports = InvalidContextKeyError;

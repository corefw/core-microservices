/**
 * @file Defines the GetManyResponse class.
 *
...
/**
 * This response class represents an API response for a 'GetMany' endpoint.
 *
 * @memberOf Response
 * @extends Response.SuccessResponse
 */
module.exports = class GetManyResponse extends SuccessResponse {

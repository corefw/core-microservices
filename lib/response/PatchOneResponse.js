/**
 * @file Defines the PatchOneResponse class.
 *
...
/**
 * This response class represents an API response for a 'PatchOne' endpoint.
 *
 * @memberOf Response
 * @extends Response.SuccessResponse
 */
module.exports = class PatchOneResponse extends SuccessResponse {

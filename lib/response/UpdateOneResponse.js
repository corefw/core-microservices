/**
 * @file Defines the UpdateOneResponse class.
 *
...
/**
 * This response class represents an API response for a 'UpdateOne' endpoint.
 *
 * @memberOf Response
 * @extends Response.SuccessResponse
 */
module.exports = class UpdateOneResponse extends SuccessResponse {

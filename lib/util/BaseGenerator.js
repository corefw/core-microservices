...
class BaseGenerator extends BaseClass {
	...
	_resolveEndpointDetails( configPath ) {
		...
		ret.endpointVersionString	= me.serviceName + "::" + ret.endpointName + "::" + me.gitBranch + "::" + me.versionFull;
		ret.endpointVersionHash		= CRYPTO.createHash( "md5" ).update( ret.endpointVersionString ).digest( "hex" );
